    ...
    if (response.conflict) {
        ...
        if (ref) {
            ...
            if (pullRequest) {
                ...
                const lastAssignee = assignees.pop();
                postMessage({
                    channel: 'devs', text: `Hey slackers, I'm trying to do my job here, but, as always, one of you is blocking me.
There was a conflict on ${repository.name}.
You know me, I only work with blaming, and based on the committers, I'm going to point my finger at ${lastAssignee}.
